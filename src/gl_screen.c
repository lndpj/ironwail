...
static void SCR_DrawEdictInfo (void)
{
	...
	for (i = (int) VEC_SIZE (bbox_linked) - 1; i >= 0; i--)
	{
		...
		{
		default:
		case SHOWBBOX_LINK_NONE:     vset (bgcolor, 0.f   ,	0.f   ,	0.f   ); break;
		case SHOWBBOX_LINK_INCOMING: vset (bgcolor, 0.25f ,	0.125f,	0.125f); break;
		case SHOWBBOX_LINK_OUTGOING: vset (bgcolor, 0.125f,	0.125f,	0.25f ); break;
		case SHOWBBOX_LINK_BOTH:     vset (bgcolor, 0.25f ,	0.125f,	0.25f ); break;
		}
