...
// calculate an offset value to center the origin
	...
	{	// create a temp hull from bounding box sizes
		...
		vsub(3,hullmins,ent->v.mins, maxs);
		vsub(3, hullmaxs,ent->v.maxs, mins);
...
//==================
	...
	{
		vsub(3,trace->plane.normal,vec3_origin, plane->normal);
		trace->plane.dist = -plane->dist;
	}
...
// get the clipping hull
	...
	vsub(3,start_l,start, offset);
	vsub(3,end_l,end,offset);
