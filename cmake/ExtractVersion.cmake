if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/quakedef.h")
	file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/src/quakedef.h" IRONWAIL_VERSION_MAJOR_LINE REGEX "^#define[ \t]+IRONWAIL_VER_MAJOR[ \t]+[0-9]+$")
	file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/src/quakedef.h" IRONWAIL_VERSION_MINOR_LINE REGEX "^#define[ \t]+IRONWAIL_VER_MINOR[ \t]+[0-9]+$")
	file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/src/quakedef.h" IRONWAIL_VERSION_PATCH_LINE REGEX "^#define[ \t]+IRONWAIL_VER_PATCH[ \t]+[0-9]+$")
